...
public class DataMungerTest {
	...
	public void testWithWhereThreeConditionsOrderBy() throws FileNotFoundException {
		...
		assertEquals("testWithWhereThreeConditionsOrderBy() : Total number of records should be 420",
				totalRecordsExpected, dataSet.size());
		...
		assertTrue(
				"testWithWhereThreeConditionsOrderBy() : Total number of records are matching but the records returned does not match the expected data",
				dataSet.toString().contains(
						"210={winner=Kolkata Knight Riders, player_of_match=AD Russell, city=Kolkata, team1=Kolkata Knight Riders, team2=Kings XI Punjab}"));
		assertTrue(
				"testWithWhereThreeConditionsOrderBy() : Total number of records are matching but the records returned does not match the expected data",
				dataSet.toString().contains(
						"420={winner=Sunrisers Hyderabad, player_of_match=BCJ Cutting, city=Bangalore, team1=Sunrisers Hyderabad, team2=Royal Challengers Bangalore}"));
